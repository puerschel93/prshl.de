...
export const Mouse: FC = () => {
  ...
  return (
    <div
      className="top-0 left-0 fixed bg-gradient-to-br from-slate-600 to-transparent opacity-50 border border-opacity-10 rounded-full w-4 pointer-events-none aspect-square"
      style={{
        left: 0,
        top: 0,
        transform: `translate(${x}px, ${y}px) scale(${isClicking ? 0.95 : isHovering ? 2 : 1})`,
